/*!
 * \file		resp_reading_coils.h
 * \brief		The Implementation of response of read_coils(0x01).
 *
...
namespace mothbus
{
	namespace pdu
	{
		...
		error_code read(Reader& reader, read_coils_pdu_resp& resp)
		{
		...
		void write(Writer& writer, const read_coils_pdu_resp& v)
		{
			write(writer, read_coils_pdu_resp::fc);
